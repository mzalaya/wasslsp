...
"""
Cauchy tvAR(2)
Ref: S. Birr, S. Volgushev, T. Kley, H. Dette, and M. Hallin. Quantile spectral analysis for locally stationary time series. 
Journal of the Royal Statistical Society. Series B (Statistical Methodology), 79(5):1619–1643, 2017
"""
...
def main():
    ...
    input_dir = "CauchytvAR2_Wass"
    output_dir = "CauchytvAR2WassStats"
    os.makedirs(output_dir, exist_ok=True)
